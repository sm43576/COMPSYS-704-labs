...
public class Plant extends ClockDomain{
  ...
  public void thread1363(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest1370 = 0;
        if(ends[8]>=biggest1370){
          biggest1370=ends[8];
        }
        if(ends[9]>=biggest1370){
          biggest1370=ends[9];
        }
        if(ends[10]>=biggest1370){
          biggest1370=ends[10];
        }
        if(ends[11]>=biggest1370){
          biggest1370=ends[11];
        }
        if(ends[12]>=biggest1370){
          biggest1370=ends[12];
        }
        if(ends[13]>=biggest1370){
          biggest1370=ends[13];
        }
        if(biggest1370 == 1){
          active[7]=1;
  ...
  public void thread1349(int [] tdone, int [] ends){
    ...
    int biggest1356 = 0;
    if(ends[8]>=biggest1356){
      biggest1356=ends[8];
    }
    if(ends[9]>=biggest1356){
      biggest1356=ends[9];
    }
    if(ends[10]>=biggest1356){
      biggest1356=ends[10];
    }
    if(ends[11]>=biggest1356){
      biggest1356=ends[11];
    }
    if(ends[12]>=biggest1356){
      biggest1356=ends[12];
    }
    if(ends[13]>=biggest1356){
      biggest1356=ends[13];
    }
    if(biggest1356 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S1342){
        ...
        case 1 : 
          ...
          if(ends[5]>=biggest1357){
            biggest1357=ends[5];
          }
          if(ends[6]>=biggest1357){
            biggest1357=ends[6];
          }
          if(ends[7]>=biggest1357){
            biggest1357=ends[7];
          }
          if(biggest1357 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest1371 = 0;
          if(ends[2]>=biggest1371){
            biggest1371=ends[2];
          }
          if(ends[3]>=biggest1371){
            biggest1371=ends[3];
          }
          if(ends[4]>=biggest1371){
            biggest1371=ends[4];
          }
          if(ends[5]>=biggest1371){
            biggest1371=ends[5];
          }
          if(ends[6]>=biggest1371){
            biggest1371=ends[6];
          }
          if(ends[7]>=biggest1371){
            biggest1371=ends[7];
          }
          if(biggest1371 == 1){
            active[1]=1;
