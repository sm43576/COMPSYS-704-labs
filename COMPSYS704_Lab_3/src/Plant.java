...
public class Plant extends ClockDomain{
  ...
  public void thread1693(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest1700 = 0;
        if(ends[8]>=biggest1700){
          biggest1700=ends[8];
        }
        if(ends[9]>=biggest1700){
          biggest1700=ends[9];
        }
        if(ends[10]>=biggest1700){
          biggest1700=ends[10];
        }
        if(ends[11]>=biggest1700){
          biggest1700=ends[11];
        }
        if(ends[12]>=biggest1700){
          biggest1700=ends[12];
        }
        if(ends[13]>=biggest1700){
          biggest1700=ends[13];
        }
        if(biggest1700 == 1){
          active[7]=1;
  ...
  public void thread1679(int [] tdone, int [] ends){
    ...
    if(ends[9]>=biggest1686){
      biggest1686=ends[9];
    }
    if(ends[10]>=biggest1686){
      biggest1686=ends[10];
    }
    if(ends[11]>=biggest1686){
      biggest1686=ends[11];
    }
    if(ends[12]>=biggest1686){
      biggest1686=ends[12];
    }
    if(ends[13]>=biggest1686){
      biggest1686=ends[13];
    }
    if(biggest1686 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S1672){
        ...
        case 1 : 
          ...
          int biggest1687 = 0;
          if(ends[2]>=biggest1687){
            biggest1687=ends[2];
          }
          if(ends[3]>=biggest1687){
            biggest1687=ends[3];
          }
          if(ends[4]>=biggest1687){
            biggest1687=ends[4];
          }
          if(ends[5]>=biggest1687){
            biggest1687=ends[5];
          }
          if(ends[6]>=biggest1687){
            biggest1687=ends[6];
          }
          if(ends[7]>=biggest1687){
            biggest1687=ends[7];
          }
          if(biggest1687 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest1701 = 0;
          if(ends[2]>=biggest1701){
            biggest1701=ends[2];
          }
          if(ends[3]>=biggest1701){
            biggest1701=ends[3];
          }
          if(ends[4]>=biggest1701){
            biggest1701=ends[4];
          }
          if(ends[5]>=biggest1701){
            biggest1701=ends[5];
          }
          if(ends[6]>=biggest1701){
            biggest1701=ends[6];
          }
          if(ends[7]>=biggest1701){
            biggest1701=ends[7];
          }
          if(biggest1701 == 1){
            active[1]=1;
