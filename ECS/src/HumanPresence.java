    ...
    RUN: while(true){
      switch(S666){
        ...
        case 1 : 
          ...
          int biggest3216 = 0;
          if(ends[2]>=biggest3216){
            biggest3216=ends[2];
          }
          if(ends[3]>=biggest3216){
            biggest3216=ends[3];
          }
          if(ends[4]>=biggest3216){
            biggest3216=ends[4];
          }
          if(ends[5]>=biggest3216){
            biggest3216=ends[5];
          }
          if(ends[6]>=biggest3216){
            biggest3216=ends[6];
          }
          if(ends[7]>=biggest3216){
            biggest3216=ends[7];
          }
          if(ends[8]>=biggest3216){
            biggest3216=ends[8];
          }
          if(biggest3216 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest3224 = 0;
          if(ends[2]>=biggest3224){
            biggest3224=ends[2];
          }
          if(ends[3]>=biggest3224){
            biggest3224=ends[3];
          }
          if(ends[4]>=biggest3224){
            biggest3224=ends[4];
          }
          if(ends[5]>=biggest3224){
            biggest3224=ends[5];
          }
          if(ends[6]>=biggest3224){
            biggest3224=ends[6];
          }
          if(ends[7]>=biggest3224){
            biggest3224=ends[7];
          }
          if(ends[8]>=biggest3224){
            biggest3224=ends[8];
          }
          if(biggest3224 == 1){
            active[1]=1;
