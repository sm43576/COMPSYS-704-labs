    ...
    RUN: while(true){
      switch(S666){
        ...
        case 1 : 
          ...
          int biggest3115 = 0;
          if(ends[2]>=biggest3115){
            biggest3115=ends[2];
          }
          if(ends[3]>=biggest3115){
            biggest3115=ends[3];
          }
          if(ends[4]>=biggest3115){
            biggest3115=ends[4];
          }
          if(ends[5]>=biggest3115){
            biggest3115=ends[5];
          }
          if(ends[6]>=biggest3115){
            biggest3115=ends[6];
          }
          if(ends[7]>=biggest3115){
            biggest3115=ends[7];
          }
          if(ends[8]>=biggest3115){
            biggest3115=ends[8];
          }
          if(biggest3115 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          if(ends[3]>=biggest3123){
            biggest3123=ends[3];
          }
          if(ends[4]>=biggest3123){
            biggest3123=ends[4];
          }
          if(ends[5]>=biggest3123){
            biggest3123=ends[5];
          }
          if(ends[6]>=biggest3123){
            biggest3123=ends[6];
          }
          if(ends[7]>=biggest3123){
            biggest3123=ends[7];
          }
